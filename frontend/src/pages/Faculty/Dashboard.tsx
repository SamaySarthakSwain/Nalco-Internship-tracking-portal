  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Welcome, Faculty</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage your assigned students and approve logs.</p>
        </div>
                ...
                <div key={i} className="flex items-center justify-between p-4 border rounded-lg dark:border-slate-800">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-primary font-medium">S{i}</span>
                    </div>
                    <div>
                      <h4 className="font-semibold text-slate-900 dark:text-white">Student {i}</h4>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Submitted weekly log for Week {i}</p>
                    </div>
                  </div>
                  <button className="px-4 py-2 bg-primary/10 text-primary hover:bg-primary/20 rounded-md text-sm font-medium transition-colors">
                    Review
                  </button>
                </div>
              ))}
